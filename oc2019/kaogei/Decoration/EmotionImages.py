...
class EmotionImages:
    ...
    def __init__(
		...
		pathOfEmotionImagesList = "./kaogei/Decoration/frame/emotionImageList.txt",
    ):
        ...
        while True:
            ...
            self.__emotionImages[pair[0]] = cv2.imread("./kaogei/Decoration/frame/" + pair[1], cv2.IMREAD_UNCHANGED)
